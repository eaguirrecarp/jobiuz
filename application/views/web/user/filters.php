...
<head>
    ...
    <link href="<?=$base?>template/css/powerange.css" rel="stylesheet">
    ...
    <script src="<?=$base?>template/js/powerange.js"></script>
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="container" style="background:#ffffff" >
            <div class="col-md-12">
                <div class="col-md-2">
                <label align="left">FILTERS</label> <br>
                </div>
                <div class="col-md-10">
                    <div class="list-group ">
                        ...
                        <div class="col-md-8 list-group-item ">
                            <div class="slider-wrapper">
                              <input type="text" class="js-check-change" style="display: none;"><span class="range-bar"><span class="range-handle" style="left: 47px;"></span><span class="range-min">0</span><span class="range-max">100</span><span class="range-quantity" style="width: 47px;"></span></span>
                              <label class="display-box-label">Value:</label>
                              <div id="js-display-change" class="display-box">21</div>
                            </div>                        </div>
                        <div class="col-md-2"></div>
                    </div>
                </div>
