            ...
            <div class="container-fluid">
                ...
                <div>
                    <p class="navbar-text navbar-right">
                        <h1 class="text-right titulo2 font36">Going mobile? <a href="http://localhost/jobiuz/index.php/web/employer/login" class="navbar-link titulo font36">Download our app here...</a></h1>
                    </p>
                </div>
            </div>
        </header>
    ...
    <div class="banner">
        <div>
            <div class="row">
                ...
                <div class="col-md-3">
                    <h2 class="titulo2s font36"><br>The place<br>where work connections</h2> 
                    <h1 class="titulo2s font60">HAPPENS!</h1>
                </div>
                <div class="col-md-1"></div>
                <div class="col-md-6">
                    <form action="<?=site_url('web/employer/authenticate')?>" class="form-signin" id="form-signin" method="post">
            ...
            <div>
                <div>
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <h1 class="text-center titulo2 font36">Not a member? <a href="<?=site_url('web/employer')?>" class="navbar-link titulo font36">Sign on here...</a></h1>
                        </div>
                    </div>                          
                </div>
            </div>
